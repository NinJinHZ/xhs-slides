...
#### 5.1 分屏美学布局（多视窗切割）
- **上下分屏**：将幻灯片分为上下两个区域，分别展示不同内容
- **上中下三分屏**：适合展示三个阶段的对比或流程
- **斜分对角线**：增加戏剧张力
- **适用场景**：多人物对比、多时间线、多方案对比
...
#### 7.1 AI辅助设计——协作者而非替代者
- AI生成3-5个初稿方向，人工进行二次创作
- AI负责效率，人类负责灵魂
- 适用场景：快速原型、灵感激发

#### 7.2 醜萌风格（Naive Design）
- 歪歪扭扭的手写字体
- 像小孩涂鸦一样的插画
- 刻意不对齐的排版
- 饱和度高的"土味"配色
...
#### 9.1 返璞归真的"真实感"美学
- **备忘录美学**：模仿手机备忘录风格，简单字体、基础排版、未经修饰的真实感
- **苹果风极简主义**：渐变浅灰背景、主文案居中、字间距宽松、大面积留白

#### 9.2 前卫的光影与材质碰撞
- **弥散光感**：画面边缘添加高斯模糊的柔和渐变光晕
- **液态玻璃**：模拟真实世界的光影、反射和透明度
- **酸性设计**：镭射金属+霓虹色彩+玻璃质感+哥特字体混搭

#### 9.3 打破常规的镜头与感官延伸
- **超大特写**：人脸放大，看清皮肤肌理和眼中情感
- **动静融合**：文字闪烁、图形呼吸、光晕渐变流动
